...
> **Data Scientist** pursuing B.Tech in Information Technology at **Institute of Engineering and Management (IEM), Kolkata** (2023 – 2027).

- 🔬 Hands-on experience building **predictive and NLP-based ML models**
- 🚀 Passionate about end-to-end ML pipelines — from data ingestion to deployment
- 🎯 Strong in **EDA, feature engineering, statistical modeling, and semantic similarity**
- 🛠 Love shipping production-ready APIs with **FastAPI + Docker**
...
|--------|------------|------|
| B.Tech — Information Technology | Institute of Engineering and Management (IEM), Kolkata | 2023 – 2027 |
| Class XII | Public School Darbhanga, Bihar | May 2022 — 76% |
